...
plot12 = scatterplot(N_FSSP[p_gt_0],N_CDP[p_gt_0], symbol='D',sym_color='r',/sym_filled,NAME='NC',TITLE='Number Concentration (cm$^{-3}$)',YTITLE = 'FSSP',XTITLE='CDP', Dimensions=[600,600])
x = [0,400]
